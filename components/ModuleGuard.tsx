...
type ModuleKey = 'mod_tareas' | 'mod_calendario' | 'mod_revenue' | 'mod_finanzas' | 'mod_producto' | 'mod_customer_success' | 'mod_comunicaciones' | 'mod_marketing' | 'mod_crm' | 'mod_contenido_social';
